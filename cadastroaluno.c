...
void cadastro(cadastro_aluno){
	...
	system("cls");
			...
			fflush(stdin);
			gotoxy(50,8);
	printf("Digite o endreço do aluno: ");
	...
	system("cls");
			...
			fflush(stdin);
			gotoxy(50,8);
	printf("Digite o colocação do aluno: ");
	...
	if(consulta == 1)
	{
		for(i=0; i < 3; i++)
		{
			if(vet_estud[i].matricula == NULL & vet_estud[0].matricula == NULL){
				printf("\nNão conseguimos mostrar nenhum dado pois não a dados cadastrados!\n");
				Sleep(4000);
				break;
			}
		...
		do
		{
			if(consul_matri < 0)
			{	
				printf("\nNão a matriculas com numeros negativos!");
			}
...
int alterar(){
	...
	for(i=0;i<3;i++)
	{
		...
		if(alterar_mat == vet_estud[i].matricula)
		{
			...
			//altera o endereço
			fflush(stdin);
			printf("\nDeseja alterar o endereco Sim( S ) ou não ( N )");
			scanf("%c", &alt_opcao);
			maiusculo = toupper(alt_opcao);
			alt_opcao = maiusculo;
			system("cls");
			...
			//altera a colocação 
			fflush(stdin);
			printf("\nDeseja alterar a colocação Sim( S ) ou não ( N )");
			scanf("%c", &alt_opcao);
			maiusculo = toupper(alt_opcao);
			alt_opcao = maiusculo;
			system("cls");
